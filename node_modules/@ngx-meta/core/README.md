...
[![Linux build](https://travis-ci.org/ngx-meta/core.svg?branch=master)](https://travis-ci.org/ngx-meta/core) [![Windows build](https://ci.appveyor.com/api/projects/status/github/ngx-meta/core?branch=master&svg=true)](https://ci.appveyor.com/project/ngx-meta/core) [![coverage](https://codecov.io/github/ngx-meta/core/coverage.svg?branch=master)](https://codecov.io/gh/ngx-meta/core) [![npm version](https://badge.fury.io/js/%40ngx-meta%2Fcore.svg)](https://www.npmjs.com/package/@ngx-meta/core)
...
- It also supports resolving values [using a `callback` function](#using-a-callback-function) to use a custom logic on the meta tag contents (*`http-get`, [@ngx-translate/core], etc.*). 
...
- [Getting started](#getting-started)
  - [Installation](#installation)
	...
	- [Adding `@ngx-meta/core` to your project (SystemJS)](#adding-ngx-metacore-to-your-project-systemjs)
